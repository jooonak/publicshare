	...
	<div id="aboutwrap">
		<div class="container">
			...
			<div style="margin-top: 2%;">
				...
				<button type="button" class="btn btn-default btn-position modBtn"
					id="regBtn" name="대여">modify</button>
				<!-- fileUpload용 div 및 버튼-->
				<button type="button" class="btn btn-primary btn-position "
					data-toggle="modal" data-target=".modalDialogA" name="대여">history</button>
...
$(".replyUL").on("click", "#replyDelBtn", function(e){
	...
	e.preventDefault();
	console.log("click....");
	console.log($(this).parent().attr("data-reno"));
