			...
			<div class="row">
				...
				<div class="col-lg-8 name-desc">
					...
					<div class="col-md-6">
						...
						<h3>글쓴이, 등록일, 조회수</h3>
						<p>책제목<input type="text" value="${book.bname}" readonly="readonly"></p>
						<p>출판사<input type="text" value="${book.publisher}"	readonly="readonly"></p>
						<p>날짜정보: <fmt:formatDate value="${book.regDate}" pattern="yyyy-MM-dd"></fmt:formatDate></p>
						<div>
